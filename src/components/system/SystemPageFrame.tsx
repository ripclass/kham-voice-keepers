  ...
  return (
    <section className="kham-frame">
      <header className="p-4 md:p-6 border-b border-dashed border-ink/20 dark:border-paper/25">
        <h1 className="font-tech uppercase tracking-[0.08em] text-2xl md:text-4xl">{title}</h1>
        {subtitle && <p className="font-display mt-2 text-sm md:text-base text-ink/80 dark:text-paper/80">{subtitle}</p>}
      </header>
