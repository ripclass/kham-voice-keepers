...
const DialectMap = () => {
  const dialects = [
    ...
    { name: "Mymensingh / Manikganj", region: "Central-North", status: "🔄 Prepping Scripts", statusText: "Scriptwriting + onboarding speakers" },
    ...
    { name: "Pabna–Sirajganj", region: "Rajshahi transition zone", status: "⚪️ Coming Soon", statusText: "Next-phase target dialect" },
    ...
    { name: "Barisali", region: "South-Central", status: "⚪️ Coming Soon", statusText: "Next-phase target dialect" },
    { name: "Khulnai", region: "South-West (Khulna–Bagerhat)", status: "🔄 Sourcing Speakers", statusText: "Scriptwriting + onboarding speakers" },
    { name: "Comilla–Tripura Border", region: "Border Dialect Zone", status: "⚪️ Coming Soon", statusText: "Next-phase target dialect" }
  ];
      ...
      <Card className="border-ink/10">
        ...
        <CardContent>
          ...
          <div className="mt-6 p-4 bg-ink/5 rounded-lg space-y-3">
            <h4 className="font-medium text-ink">Status Key:</h4>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-2 text-sm text-ink/70">
              ...
              <div><span className="font-mono">🔄</span> Prepping Scripts – Scriptwriting + onboarding speakers</div>
              <div><span className="font-mono">⚪️</span> Coming Soon – Next-phase target dialect</div>
            </div>
          </div>
        </CardContent>
      </Card>
